...
public class DataInitializer {
    ...
    public CommandLineRunner initializeData(){
        return (args -> {
            ...
            user1.getUser_groups().add(group1);
            user2.getUser_groups().add(group1);
            user2.getUser_groups().add(group2);
            user3.getUser_groups().add(group2);
            ...
            post1.setSocial_user_id(user1);
            post2.setSocial_user_id(user2);
            post3.setSocial_user_id(user3);
            ...
            profile1.setUser_id(user1);
            profile2.setUser_id(user2);
            profile3.setUser_id(user3);
